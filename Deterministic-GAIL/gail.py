...
class GAIL:
    ...
    def save(self, directory='/home/anas-nouri/TORCS-GAIL/Deterministic-GAIL/weights', name='GAIL'):
    ...
    def load(self, directory='/home/anas-nouri/TORCS-GAIL/Deterministic-GAIL/weights', name='GAIL'):
        print(os.getcwd())
